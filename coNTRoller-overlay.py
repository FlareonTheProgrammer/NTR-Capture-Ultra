...
if __name__ == '__main__':
	...
	while not closed:
		...
		overlay()
		circle_stick((47, 287), input_state.circle_x, input_state.circle_y)
		button_circle((422,  325), 12, input_state.button_a)
		button_circle((398,  348), 12, input_state.button_b)
		button_circle((398,  302), 12, input_state.button_x)
		button_circle((374,  325), 12, input_state.button_y)

		button_circle((374, 396), 7,  input_state.button_start)
		button_circle((374, 424), 7,  input_state.button_select)

		button_rect(( 21, 356, 18, 18), input_state.button_left)
		button_rect(( 56, 356, 18, 18), input_state.button_right)
		button_rect(( 39,  339, 17, 17), input_state.button_up)
		button_rect(( 39, 374, 17, 17), input_state.button_down)

		button_rect((  21,   237, 32, 15), input_state.button_l)
		button_rect((393,   237, 32, 15), input_state.button_r)
